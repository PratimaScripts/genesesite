...
import { faPiggyBank, faShoppingCart, faRoute, faHamburger, faTv, faHeartbeat, faUserFriends, faMagic, faThumbsUp, faServer, faShieldAlt, faRocket } from "@fortawesome/free-solid-svg-icons";
  ...
  return (
    <div>
        <div id="carousel">
              ...
              <Container fluid className="p-0">
				  <Row className="m-0">
				  	<Col lg={6} className="p-0">
					  	<div className="section-image" style={{ backgroundImage: `url(${CloudExpert})` }}>
						</div>
					  </Col>
					  <Col lg={6} className="p-0">
		  ...
		  <div className="section text-white with-background" style={{ backgroundImage: `url(${WebDevelopment})` }}>
              <Container className="p-0">
				  <h3>We build search optimised secure websites, mobile apps and cloud services in a cost-effective way.</h3>
				  <Row className="m-0">
				  	<Col lg={6} className="p-0">
					  ...
					  <Col lg={4}>
						  <Card>
							  <Card.Body>
					  			...
					  			<p>Our loyal and experienced team can streamline and enhance the operational efficiency of your business through faster and more resilient development.</p>
							  </Card.Body>
							</Card>
					</Col>
					  <Col lg={4}>
						  <Card>
							  <Card.Body>
					  			...
					  			<p>We are test-oriented, utilising test automation to build and assure quality into every product.</p>
							  </Card.Body>
							</Card>
					</Col>
					  <Col lg={4}>
						  <Card>
							  <Card.Body>
					  			...
					  			<p>You can scale your IT resources on-demand, reliably and securely according to your project needs.</p>
							  </Card.Body>
							</Card>
					</Col>
					  <Col lg={4}>
						  <Card>
							  <Card.Body>
					  			...
					  			<p>We'll advise on, provision and manage your cloud infrastructure, reducing cost and improving security and compliance.</p>
							  </Card.Body>
							</Card>
					</Col>
					  <Col lg={4}>
						  <Card>
							  <Card.Body>
					  			...
					  			<p>As cloud and security specialists we'll help you migrate your services to the cloud and integrate enterprise services seamlessly and securely. Using cloud managed services you can reduce capital or operational expense, accelerate time-to-business-value and improve on ROI.</p>
							  </Card.Body>
							</Card>
					</Col>
				  </Row>
		  ...
		  <div className="section bg-primary text-white">
              <Container>
				  <h3>Having worked across a wide range of industries, we can help you</h3>
				  <Row className="boxes">
				  	<Col lg={4}>
						<Card>
							<Card.Body>
